...
FINGERPRINT_ENV_KEYS = (
    ...
    "PROTO_BAYESIAN_CONTROL_RHO",
    "PROTO_BAYESIAN_CONTROL_WEIGHT",
    "PROTO_BAYESIAN_POLICY_LITE_MODE",
    "PROTO_BAYESIAN_POLICY_LITE_TAU",
    "PROTO_BAYESIAN_POLICY_LITE_CONFIDENCE_K",
    "PROTO_BAYESIAN_POLICY_LITE_RHO",
    "PROTO_BAYESIAN_POLICY_LITE_WEIGHT",
    ...
    "PROTO_BAYESIAN_POLICY_LITE_MAX_DELTA",
    "PROTO_BAYESIAN_POLICY_LITE_PROB_FLOOR",
